...
class Bisection extends Component{
    ...
    state = {
      ...
      constructor(props)
      {
        ...
        componentDidMount()
    {
         axios.get('http://localhost:8080/bisection.php') //Docker//
        // axios.get('http://localhost/numer/server/bisection.php')
    ...
    getValue = ()=>{
      ...
      EquationBisection = () =>{
        ...
        formData.append("t_type","Bisectioon");
      ...
      showResult=()=>{
        ...
        {
          return <div>
          <center>  <h5>This is Result of bisection : {this.state.result}</h5></center><br/>
      ...
      <div className="box" style={{ padding: 24, minHeight: 500 }}>
                 ...
                 <div >
                   <center><h2>BISECTION</h2></center> 
                           ...
                           <div>                   
                        <center> 
                          <Cascader options={this.state.options}expandTrigger="hover"displayRender={this.displayRender}onChange={this.onChange}/> </center>
           </div>
           <br></br>
           <div>
